    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_method', models.SmallIntegerField(verbose_name='订单状态', default=1, choices=[(1, '货到付款'), (2, '微信支付'), (3, '支付宝'), (4, '银联支付')])),
                ('total_count', models.IntegerField(verbose_name='商品数量', default=1)),
                ('total_price', models.DecimalField(verbose_name='123', max_digits=10, decimal_places=2)),
                ('transit_price', models.DecimalField(verbose_name='123', max_digits=10, decimal_places=2)),
                ('order_status', models.SmallIntegerField(verbose_name='123', default=1, choices=[(1, '待支付'), (2, '待发货'), (3, '待收货'), (4, '待评价'), (5, '已完成')])),
