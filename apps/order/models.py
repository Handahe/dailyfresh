...
class OrderInfo(BaseModel):
    ...
    pay_method = models.SmallIntegerField(choices=PAY_METHOD_CHOICES,default=1,verbose_name='订单状态')
    total_count = models.IntegerField(default=1,verbose_name='商品数量')
    total_price = models.DecimalField(max_digits=10,decimal_places=2,verbose_name='123')
    transit_price = models.DecimalField(max_digits=10,decimal_places=2,verbose_name='123')
    order_status = models.SmallIntegerField(choices=ORDER_STATUS_CHOICES,default=1,verbose_name='123')
